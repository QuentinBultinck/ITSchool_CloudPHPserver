...
@section('content')
    ...
    <form action="{{ route("updateRestaurant") }}" method="post">
        {{ csrf_field() }}
        {{ method_field("PATCH") }}
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" id="inputName" disabled="disabled" required name="name" value="{{ $restaurant->name }}">
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-12">
                <label for="inputInfo">Info</label>
                <textarea class="form-control" id="inputInfo" rows="4" name="info">{{ $restaurant->info }}</textarea>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-3">
                <label for="inputTag">Add tag</label>
                <input type="text" class="form-control" id="inputTag" value="{{ $restaurant->tags[0]->name }}" required
                       placeholder="Picturesque"
                       name="tag0">
            </div>
            <div class="form-group col-md-3">
                <label for="inputTag1">Tag 2</label>
                <input type="text" class="form-control" id="inputTag1" value="{{ empty($restaurant->tags[1]) ? "" : $restaurant->tags[1]->name }}" placeholder="Chinese"
                       name="tag1">
            </div>
            <div class="form-group col-md-3">
                <label for="inputTag2">Tag 3</label>
                <input type="text" class="form-control" id="inputTag2" value="{{ empty($restaurant->tags[2]) ? "" : $restaurant->tags[1]->name }}" placeholder="Steak"
                       name="tag2">
            </div>
            <div class="form-group col-md-3">
                <label for="inputTag3">Tag 4</label>
                <input type="text" class="form-control" id="inputTag3" value="{{ empty($restaurant->tags[3]) ? "" : $restaurant->tags[1]->name }}" placeholder="Peruvian"
                       name="tag3">
            </div>
        </div>
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="time" class="form-control" id="inputClosingTime" value="{{ $restaurant->closingTime }}" required
                       name="closingTime">
            </div>
            <div class="form-group col-md-4">
                <label for="inputCuisine">Amount of Tables</label>
                <input type="number" class="form-control" id="inputCuisine" min="1" max="50"
                       value="{{ $restaurant->tables }}" required name="tables">
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-8">
                <label for="inputAddressStreet">Street</label>
                <input type="text" class="form-control" id="inputAddressStreet" value="{{ $restaurant->street }}" required
                       name="street">
            </div>
            <div class="form-group col-md-4">
                <label for="inputHouseNumber">House Number</label>
                <input type="text" class="form-control" id="inputHouseNumber" value="{{ $restaurant->houseNumber }}" required
                       name="houseNumber">
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="inputCity" value="{{ $restaurant->city }}" required name="city">
            </div>
            <div class="form-group col-md-6">
