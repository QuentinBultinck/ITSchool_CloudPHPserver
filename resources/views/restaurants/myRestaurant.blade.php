    ...
    <form action="{{ route("updateRestaurant") }}" method="post">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" id="inputName" disabled="disabled" required name="name"
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control" id="inputTag1"
                       value="{{ empty($restaurant->tags[1]) ? "" : $restaurant->tags[1]->name }}" placeholder="Chinese"
                       name="tag1">
            </div>
            <div class="form-group col-md-3">
                <label for="inputTag2">Tag 3</label>
                <input type="text" class="form-control" id="inputTag2"
                       value="{{ empty($restaurant->tags[2]) ? "" : $restaurant->tags[2]->name }}" placeholder="Steak"
                       name="tag2">
            </div>
            <div class="form-group col-md-3">
                <label for="inputTag3">Tag 4</label>
                <input type="text" class="form-control" id="inputTag3"
                       value="{{ empty($restaurant->tags[3]) ? "" : $restaurant->tags[3]->name }}"
                       placeholder="Peruvian"
                       name="tag3">
            </div>
        </div>
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="time" class="form-control" id="inputClosingTime" value="{{ $restaurant->closingTime }}"
                       required
                       name="closingTime">
            </div>
            <div class="form-group col-md-4">
        ...
        <div class="row">
            <div class="form-group col-md-8">
                ...
                <input type="text" class="form-control" id="inputAddressStreet" value="{{ $restaurant->street }}"
                       required
                       name="street">
            </div>
            <div class="form-group col-md-4">
                <label for="inputHouseNumber">House Number</label>
                <input type="text" class="form-control" id="inputHouseNumber" value="{{ $restaurant->houseNumber }}"
                       required
                       name="houseNumber">
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="inputCity" value="{{ $restaurant->city }}" required
                       name="city">
            </div>
            <div class="form-group col-md-6">
